            ...
            if (self.mda[n_habilidade] >= saving_thrown and players[alvo].nome != self.nome):
                ...
                if(players[alvo].classe == "guerreiro"):
                    ...
                    if (crit>=saving_thrown):
                        print('\nAcerto Crítico!\nDano Dobrado!\n')
                        players[alvo].vida-=((self.dano[n_habilidade]+int(self.dano[n_habilidade]*self.raiva_interior)-int(self.dano[n_habilidade]*players[alvo].levantar_escudo)-10)*2)
                    else:
                    ...
                    if (crit>=saving_thrown):
                        print('\nAcerto Crítico!\nDano Dobrado!\n')
                        players[alvo].vida-=((self.dano[n_habilidade]+int(self.dano[n_habilidade]*self.raiva_interior))*2)
                    else:
